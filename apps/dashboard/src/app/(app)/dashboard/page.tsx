...
const STATS = [
  { label: 'Repositories Scanned', value: '—', sub: 'Scan an org to populate', color: 'text-indigo-400' },
  { label: 'Vulnerabilities Found', value: '—', sub: 'Run a scan to detect issues', color: 'text-orange-400' },
  { label: 'Security Score', value: '—', sub: 'Score generated after scanning', color: 'text-emerald-400' },
...
const QUICK_ACTIONS = [
  {
    ...
    description: 'Enter any public GitHub org to instantly scan its repos for vulnerabilities.',
    href: '/scan',
    cta: 'Start scanning',
  ...
  },
  {
    ...
    description: 'Browse all detected security issues, filter by severity, and track resolution.',
  ...
  },
  {
    ...
    description: 'Review AI-generated PRs that automatically patch security vulnerabilities.',
    href: '/prs',
    cta: 'View PRs',
  ...
  },
  {
    ...
    description: 'Track your overall security posture with trends and repository breakdowns.',
    href: '/score',
    cta: 'View score',
...
const FEATURES = [
  ...
  { icon: Lock, title: '18 vulnerability types', desc: 'SQL injection, XSS, hardcoded secrets, SSRF, command injection and more.' },
      ...
      <div className="flex items-start justify-between gap-4 flex-wrap">
        <div>
          ...
          <p className="text-gray-400 mt-1 text-sm">
            Scan any public GitHub org — no API key, no setup required.
          </p>
        </div>
        <Link
          href="/scan"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {QUICK_ACTIONS.map(a => (
            <Link
              key={a.title}
              href={a.href}
              className={`group bg-gradient-to-br ${a.gradient} ${a.border} border rounded-xl p-6 transition-all block`}
            >
              <div className="flex items-start justify-between mb-4">
                <div className={`p-2 rounded-lg ${a.iconBg} ${a.iconColor}`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {FEATURES.map(f => (
            <div key={f.title} className="flex gap-3">
              <div className="p-2 h-fit rounded-lg bg-indigo-500/10 text-indigo-400 shrink-0">
